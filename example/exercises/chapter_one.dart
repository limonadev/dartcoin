...
class ChapterOne {
  ...
  void _first() {
    ...
    var a = FieldElement(prime: 13, value: 7);
    var b = FieldElement(prime: 13, value: 6);
  ...
  void _second() {
    ...
    var a = FieldElement(prime: 13, value: 7);
    var b = FieldElement(prime: 13, value: 12);
    var c = FieldElement(prime: 13, value: 6);
  ...
  void _third() {
    ...
    var a = FieldElement(prime: 13, value: 3);
    var b = FieldElement(prime: 13, value: 12);
    var c = FieldElement(prime: 13, value: 10);
    print(a * b == c);
  }
  ...
  void _fourth() {
    ...
    var a = FieldElement(prime: 13, value: 3);
    var b = FieldElement(prime: 13, value: 1);
    print(a.pow(3) == b);
  }
  ...
  void _fifth() {
    ...
    var a = FieldElement(prime: 13, value: 7);
    var b = FieldElement(prime: 13, value: 8);
    print(a.pow(-3) == b);
  }
